...
print('plot1.R: Step 0 - Sourcing R script and loading data set into R')
...
print('plot1.R: hpc_data data set loaded')

## Step 1 - Producing plot1.png plot
print('plot1.R: Step 1 - Producing plot1.png plot')
## Validating if plot already existed. If so, removing it.
plotname <- 'plot1.png'
if (file.exists(plotname)){
        file.remove(plotname)
        print('plot1.R: Existing plot was removed')
}
...
dev.off()
print(paste('plot1.R:', plotname, 'created'))
