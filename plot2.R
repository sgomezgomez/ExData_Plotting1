...
print('plot2.R: Step 0 - Sourcing R script and loading data set into R')
...
print('plot2.R: hpc_data data set loaded')

## Step 1 - Producing plot2.png plot
print('plot2.R: Step 1 - Producing plot2.png plot')
## Validating if plot already existed. If so, removing it.
plotname <- 'plot2.png'
if (file.exists(plotname)){
        file.remove(plotname)
        print('plot2.R: Existing plot was removed')
}
...
dev.off()
print(paste('plot2.R:', plotname, 'created'))
